...
To autotune:
1. Set system constants for gravity, initial length, mass, and dampening
2. Run the tuner
...
To tune the tuner: adjust the score function to give higher/lower weighting to whichever parameter you want
